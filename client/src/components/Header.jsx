  ...
  return (
    <div className={`flex w-full md:w-1/3 items-center ${styles}`}>
      ...
      <input
        ...
        style={{
          backgroundColor: '#ccc',
          borderRadius: '9999px', // Set a large value for curved boundary
        }}
...
const Header = ({
  ...
  return (
    <div className='bg-[#f7fdfd]'>
      ...
      >
        <div className='w-full h-full absolute top-24 md:top-6 lg:top-3 left-3 z-20'> {/* Add a higher z-index here */}
          <img src={HeroImage} className=' w-full md:top-auto md:bottom-0 lg:top-0 lg:bottom-auto' />
        </div>
          
        <div className='w-full z-10'>
          <div className='mb-8'>
            <p className='text-slate-700 font-bold text-4xl'></p>
          </div>


          <div className='w-full mt-[1000px] flex items-center justify-around bg-white px-2 md:px-5 py-2.5 md:py-6 shadow-2xl rounded-full'>
            <SearchInput
