        ...
        <div className='bg-[#001a36]'>
          <div className='container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row'>
            <p className='text-gray-300 text-sm text-center sm:text-left'>
              ...
              <Link to='/privacy-policy' className='ml-2 text-[#1199e7] hover:underline'>Privacy Policy</Link>
              <span className="ml-2">|</span>
              <Link to='/license' className='ml-2 text-[#1199e7] hover:underline'>License</Link>
              <span className="ml-2">|</span>
              <Link to='/api' className='ml-2 text-[#1199e7] hover:underline'>API</Link>
              <span className="ml-2">|</span>
              <span className='ml-2'>Currency-USD</span>
              <span className="ml-2">|</span>
              <span className="ml-2">
              <span role="img" aria-label="globe">🌐</span> English</span>
            </p>
